...
\textsc{\large Master's Thesis}\\[5cm] % Minor heading such as course title
...
\HRule \\[0.4cm]
{ \huge \bfseries Graph Neural Network Applications}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
...
\emph{Professor:} \\
 Marta Arias Vicente   % Supervisor's Name
\end{flushright}
\end{minipage}\\[2cm]
