...
\input{./tables/exp1_results_slide.tex}
...
\begin{itemize}
    ...
    %\item Edge betweenness seems to be a very delicate measure to approximate
\end{itemize}
...
\begin{itemize}
    ...
    \item However, it has not been proven that they outperform other methods in those particular experiments, just that they are compatible to some extent. % even thought it has been methodologicaly proven that they were probably not the best models to use in both cases, plus experiment 2 problem was ill-posed or too ambitious and training resources were not enought for some kind
